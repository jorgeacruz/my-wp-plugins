      ...
      void 0 === window.vc && (window.vc = {}), window.vc.ShortcodesBuilder = function(models) {
          ...
          build: function(shortcodes, callback) {
              this.ajax({
                  ...
                  }, this), _.isFunction(callback) && callback(html), window.vc.frame.setSortable(), window.vc.activity = !1, this.checkNoContent(), window.vc.frame_window.vc_iframe.loadScripts(), this.last() && vc.frame.scrollTo(this.first()), this.models = [], this.showResultMessage(), this.is_build_complete = !0, vc.events.trigger("afterLoadShortcode")
              })
          },
          lastID: function() {
      ...
      window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
          ...
          createElement: function(e) {
              ...
              _.isString(vc.getMapped(tag).default_content) && vc.getMapped(tag).default_content.length && (row_params = this.builder.parse({}, window.vc.getMapped(tag).default_content, this.builder.last().toJSON()), _.each(row_params, function(object) {
                  object.default_content = !0, this.builder.create(object)
                }, this)), this.model = this.builder.last(), window.vc.latestAddedElement = this.model, column_params = !(_.isBoolean(vc.getMapped(tag).show_settings_on_create) && !1 === vc.getMapped(tag).show_settings_on_create), this.hide(), column_params && this.showEditForm(), this.builder.render()
          }
      })
  }(window.jQuery),
  function($) {
    ...
    function($) {
        ...
        vc.SeoAnalysisView = Backbone.View.extend({
            ...
            getContentWrapper: function() {
                // nectar addition
                return "admin_frontend_editor" === window.vc_mode ? vc.$frame.contents().find(".container-wrap > .main-content") : $("#wpbakery_content")
                // nectar addition end
            }
