        ...
        vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
            ...
            changeShortcodeParams: function(model) {
                ...
                _.defer(function() {
                    ...
                    _.isObject(vc.atts[param_settings.type]) && 
                    _.isFunction(vc.atts[param_settings.type].render) && 
                    (value = vc.atts[param_settings.type].render.call(this, param_settings, value)), 
                    $wrapper.children("." + param_settings.param_name).is("input,textarea,select") ? 
                        $wrapper.children("[name=" + param_settings.param_name + "]").val(value) : 
                        $wrapper.children("." + param_settings.param_name).is("iframe") ? 
                            $wrapper.children("[name=" + param_settings.param_name + "]").attr("src", value) : 
                            $wrapper.children("." + param_settings.param_name).is("img") ? 
